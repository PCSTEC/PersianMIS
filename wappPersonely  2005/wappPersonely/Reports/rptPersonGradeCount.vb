...
Public Class rptPersonGradeCount
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPersonGradeCount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPersonGradeCount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPersonGradeCount = New rptPersonGradeCount
        rpt.Site = Me.Site
        Return rpt
    End Function
