...
Public Class Rpt_KarkardPersonel
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_KarkardPersonel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_KarkardPersonel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_KarkardPersonel = New Rpt_KarkardPersonel
        rpt.Site = Me.Site
        Return rpt
    End Function
