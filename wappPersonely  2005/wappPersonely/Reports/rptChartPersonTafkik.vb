...
Public Class rptChartPersonTafkik
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptChartPersonTafkik.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptChartPersonTafkik
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptChartPersonTafkik = New rptChartPersonTafkik
        rpt.Site = Me.Site
        Return rpt
    End Function
