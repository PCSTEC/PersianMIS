...
Public Class rptPersonAndTrinning
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPersonAndTrinning.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPersonAndTrinning
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPersonAndTrinning = New rptPersonAndTrinning
        rpt.Site = Me.Site
        Return rpt
    End Function
