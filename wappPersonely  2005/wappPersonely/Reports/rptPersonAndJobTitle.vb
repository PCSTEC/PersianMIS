...
Public Class rptPersonAndJobTitle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPersonAndJobTitle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPersonAndJobTitle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPersonAndJobTitle = New rptPersonAndJobTitle
        rpt.Site = Me.Site
        Return rpt
    End Function
