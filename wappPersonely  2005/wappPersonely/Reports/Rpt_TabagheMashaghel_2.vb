...
Public Class Rpt_TabagheMashaghel_2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_TabagheMashaghel_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_TabagheMashaghel_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_TabagheMashaghel_2 = New Rpt_TabagheMashaghel_2
        rpt.Site = Me.Site
        Return rpt
    End Function
