...
Public Class rptMostaafiPersonAndTrinning
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMostaafiPersonAndTrinning.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMostaafiPersonAndTrinning
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMostaafiPersonAndTrinning = New rptMostaafiPersonAndTrinning
        rpt.Site = Me.Site
        Return rpt
    End Function
