...
Public Class rptPersonAddress
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MDeparttxt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPersonAddress
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPersonAddress = New rptPersonAddress
        rpt.Site = Me.Site
        Return rpt
    End Function
