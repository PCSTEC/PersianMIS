...
Public Class rptPersonBeTafkikAlefba
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPersonBeTafkikAlefba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPersonBeTafkikAlefba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPersonBeTafkikAlefba = New rptPersonBeTafkikAlefba
        rpt.Site = Me.Site
        Return rpt
    End Function
