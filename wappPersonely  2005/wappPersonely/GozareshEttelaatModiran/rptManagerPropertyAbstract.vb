...
Public Class rptManagerPropertyAbstract
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptManagerPropertyAbstract.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SubRepForrptManagerPryAbstractrpt_CurDate() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SubRepForrptManagerPryAbstractrpt_Pm_VwHR_rptManagerPropertyAbstractPersonCode() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SubrptEducationrpt_Pm_VwHR_rptManagerPropertyAbstractPersonCode() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_subrptSavabeghDakhelirpt_Pm_VwHR_rptManagerPropertyAbstractPersonCode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptManagerPropertyAbstract
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptManagerPropertyAbstract = New rptManagerPropertyAbstract
        rpt.Site = Me.Site
        Return rpt
    End Function
