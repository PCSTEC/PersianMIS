...
Public Class subrptSavabeghDakheli
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "subrptSavabeghDakheli.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedsubrptSavabeghDakheli
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As subrptSavabeghDakheli = New subrptSavabeghDakheli
        rpt.Site = Me.Site
        Return rpt
    End Function
